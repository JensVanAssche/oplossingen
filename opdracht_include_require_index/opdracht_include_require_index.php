<?php
	$artikels = array(
		...
		array(
			...
			"tags" => "bizar, rasmus lerdorf, feestneus"
			),
		);

	include "include-require-htmls/header_partial.html";
	include "include-require-htmls/body_partial.html";
	include "include-require-htmls/footer_partial.html";
?>