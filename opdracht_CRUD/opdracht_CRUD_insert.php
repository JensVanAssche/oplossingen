<?php
	try
    {
		...
		$brewersQueryString = "SELECT brnaam, adres, postcode, gemeente, omzet FROM brouwers";
        ...
        {
			$insertBrewerQueryString = "INSERT INTO brouwers (brnaam, adres, postcode, gemeente, omzet) VALUES (:brewerName, :address, :postalCode, :city, :revenue)";
